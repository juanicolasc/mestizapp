class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:date, :observations, :total_value, :tax, :tip, :guests, :user_id, :customer_id, :table_id, :aditions, :status, :payment_method)
    end
end
